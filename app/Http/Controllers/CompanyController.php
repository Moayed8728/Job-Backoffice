...
class CompanyController extends Controller
{
  ...
  public function index(Request $request)
    ...
    public function store(CompanyCreateRequest $request)
    {
        ...
        return redirect()->route('company.index')->with('error', 'failed to create owner');
    }
    ...
    public function destroy(string $id)
    {
        ...
        $category->delete();
        return redirect()->route('companies.index')->with('success','company archieved successfully!');

    }

    public function restore(string $id){
        $category = Company::onlyTrashed()->findOrFail($id);
        $category->restore();
